...
INSERT INTO `cupon` VALUES (1,'Ropita Sale -$5000 off','Roipta','porcentaje',50.00,'https://i.ibb.co/TxNMLrND/cupon-de-descuento.png','2025-05-30');
/*!40000 ALTER TABLE `cupon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cupon_usuario`
--
...
CREATE TABLE `cupon_usuario` (
  ...
  CONSTRAINT `cupon_usuario_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cupon_usuario_ibfk_2` FOREIGN KEY (`cupon_id`) REFERENCES `cupon` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cupon_usuario`
--

LOCK TABLES `cupon_usuario` WRITE;
/*!40000 ALTER TABLE `cupon_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `cupon_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_admin_log` VALUES (1,'2024-05-14 01:17:03.365380','1','Tipodoc object (1)',1,'[{\"added\": {}}]',13,1),(2,'2024-06-03 23:46:09.847634','3','migue',1,'[{\"added\": {}}]',4,2),(3,'2024-06-09 23:27:29.119341','admin','admin',1,'[{\"added\": {}}]',24,1),(4,'2025-05-02 02:05:42.181928','1','Ropita Sale -$5000 off - porcentaje: 50',1,'[{\"added\": {}}]',42,12);
...
-- Dump completed on 2025-05-01 23:11:45
